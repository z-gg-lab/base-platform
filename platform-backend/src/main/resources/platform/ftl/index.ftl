...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
	<div region="north" split="true" style="height:30px;border:none;">
	    <div style="overflow: hidden;background: url(${webRoot}/statics/base/images/layout-browser-hd-bg.gif) #7f99be repeat-x center 50%;
	        ...
	        <span style="padding-left:10px; font-size: 16px; ">
	        	<img src="${webRoot}/statics/base/images/blocks.gif" width="20" height="20" align="absmiddle"/>${systemName!''}
	    	</span>
	    	<div id="themes" style="float:right;padding-left:10px;">
	            <span>更换皮肤：</span>
	    	...
	    	<div id="sysBtn">
	    		<ul>
	    			<li>欢迎</li>
	    			<li><a href="javascript:void(0)" id="editProfile" style="text-decoration:none;">【${currentUser.userName!}】</a></li>
	    			<li><img src="${webRoot}/statics/base/images/lock.png" width="16" height="16"/></li>
	    			<li><a href="javascript:void(0)" id="loginLock" onclick="loginLock()">锁定系统</a></li>
	    			<li><img src="${webRoot}/statics/base/images/door_out.png" width="16" height="16"/></li>
	    			<li><a href="${webRoot}/logout" id="loginOut">退出系统</a></li>
	    		</ul>
	    	</div>
	    </div>
	</div>
	...
	<script type="text/javascript">
		...
		//点击锁定按钮
		function loginLock(){
			var url = "${webRoot}/lock?userId=${currentUser.userId!}";
			$("#dialog").dialog({
				title:"锁定",
				content:createFrame1(url),
				modal:true,
				width:300,
				height:140,
	 ...
	 function createFrame1(url) {
	        var s = '<iframe name="mainFrame" id="mainFrame" scrolling="no" frameborder="0"  src="' + url + '" style="width:100%;height:95%;"></iframe>';
	        return s;
	    }
