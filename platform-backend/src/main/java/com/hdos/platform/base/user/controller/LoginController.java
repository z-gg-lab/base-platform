...
public class LoginController {
	...
	public String lock( HttpServletRequest request,Model model){
		String userId = request.getParameter("userId");
		model.addAttribute("userId", userId);
		String globalTimeout = Integer.toString(request.getSession().getMaxInactiveInterval());
		model.addAttribute("globalTimeout", globalTimeout);
		request.getSession().setMaxInactiveInterval(-9);
		return "lock";
	}
}
